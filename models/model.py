...
def _main():
    ...
    manager = QuickdrawManager(categories=[
        ...
        "backpack", "banana", "barn", "baseball bat", "basketball", "bat", "bear",
        "bed", "bee", "bicycle", "bird", "birthday cake", "book", "boomerang",
        "bread", "bridge", "broom", "bucket", "bus", "butterfly", "cactus", "cake",
        "camel", "camera", "campfire", "candle", "cannon", "car", "carrot",
        "castle", "cat", "chair", "church", "circle", "clock", "cloud",
        "coffee cup", "compass", "computer", "cookie", "couch", "cow", "crab",
        "crayon", "crocodile", "crown", "cup", "diamond", "dishwasher", "dog",
        "dolphin", "donut", "door", "dragon", "dresser", "drill", "drums",
        "duck", "dumbbell", "ear", "elephant", "envelope", "eye", "eyeglasses",
        "feather", "fence", "fish", "flamingo", "flashlight", "flip flops",
        "flower", "fork", "frog", "frying pan", "giraffe", "golf club", "grapes",
        "guitar", "hamburger", "hammer", "hand", "harp", "hat", "headphones",
        "hedgehog", "helicopter", "helmet", "horse", "hospital", "hot air balloon",
        "hot dog", "hourglass", "house", "ice cream", "jacket", "kangaroo",
        "key", "keyboard", "knife", "ladder", "lantern", "laptop", "leaf",
        "light bulb", "lighthouse", "lightning", "lion", "lipstick", "lobster",
        "lollipop", "mailbox", "map", "marker", "megaphone", "microphone",
        "monkey", "moon", "motorbike", "mountain", "mouse", "mug", "mushroom",
        "nail", "nose", "octopus", "onion", "oven", "owl", "paintbrush",
        "palm tree", "panda", "pencil", "penguin", "piano", "pig", "pineapple",
        "pizza", "police car", "popsicle", "rabbit", "radio", "rain", "rainbow",
        "rake", "rhinoceros", "river", "roller coaster", "sailboat", "sandwich",
        "scissors", "shark", "sheep", "shoe", "shovel", "skateboard", "skull",
        "snail", "snake", "snowflake", "snowman", "soccer ball", "spider",
        "spoon", "star", "steak", "stop sign", "strawberry", "submarine",
        "suitcase", "sun", "swan", "sword", "table", "teapot", "teddy-bear",
        "telephone", "television", "tennis racquet", "tent", "tiger", "toaster",
        "toilet", "tooth", "toothbrush", "tornado", "tractor", "traffic light",
        "train", "tree", "truck", "trumpet", "umbrella", "van", "vase",
        "violin", "watermelon", "whale", "windmill", "wine glass", "zebra",
    ])
    train_data = manager.sample_images(n=1000000, seed=42)
    val_data = manager.sample_images(n=100000, seed=123)
